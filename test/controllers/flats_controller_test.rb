...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference("Flat.count") do
      post flats_url, params: { flat: { address: @flat.address, description: @flat.description, name: @flat.name, numbe_of_guests: @flat.numbe_of_guests, price_per_night: @flat.price_per_night } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { address: @flat.address, description: @flat.description, name: @flat.name, numbe_of_guests: @flat.numbe_of_guests, price_per_night: @flat.price_per_night } }
